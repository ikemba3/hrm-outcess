...
import { createleaveApplicationReducer, getleaveApplicationDetailsReducer, leaveApplicationDetailsEmployeeReducer, updateleaveApplicationDetailsEmployeeReducer } from './reducers/myLeaveReducer';
// import { getAllEmployeeLeaveApplication } from './actions/leaveApplication'
...
const reducer = combineReducers({
    ...
    myLeaveDetails: getleaveApplicationDetailsReducer,
    myLeaveUpdate: updateleaveApplicationDetailsEmployeeReducer,
    myLeaveCreate: createleaveApplicationReducer,
    myleaveDetailsEmpId: leaveApplicationDetailsEmployeeReducer,
    // getAllLeave: getAllEmployeeLeaveApplication
